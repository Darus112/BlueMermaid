          ...
          <div className="form_wrapper">
            <form name="booking" method="POST" netlify="true">
              ...
              <div className="form_group">
                ...
                <select defaultValue={'DEFAULT'} name="Table Type" id="tableType" required>
              ...
              <div className="form_group">
                ...
                <select defaultValue={'DEFAULT'} name="Placement" id="placement">
                  <option value="DEFAULT" disabled>Choose</option>
              ...
              <button type="submit" className="btn-bg">Book Table</button>
            </form>
          </div>
        </div>
      </Bounce>
